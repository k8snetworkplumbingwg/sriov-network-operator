...
func (r *SriovOperatorConfigReconciler) syncWebhookObject(dc *sriovnetworkv1.SriovOperatorConfig, obj *uns.Unstructured) error {
	...
	case "MutatingWebhookConfiguration":
		whs := &admv1.MutatingWebhookConfiguration{}
	...
	case "ValidatingWebhookConfiguration":
		whs := &admv1.ValidatingWebhookConfiguration{}
		err = scheme.Convert(obj, whs, nil)
...
func (r *SriovOperatorConfigReconciler) syncMutatingWebhook(cr *sriovnetworkv1.SriovOperatorConfig, in *admv1.MutatingWebhookConfiguration) error {
	...
	deprecated_webhook := &admv1.MutatingWebhookConfiguration{}
...
func (r *SriovOperatorConfigReconciler) syncValidatingWebhook(cr *sriovnetworkv1.SriovOperatorConfig, in *admv1.ValidatingWebhookConfiguration) error {
	...
	deprecated_webhook := &admv1.ValidatingWebhookConfiguration{}
	err = r.Get(context.TODO(), types.NamespacedName{Name: DEPRECATED_OPERATOR_WEBHOOK_NAME}, deprecated_webhook)
	if err != nil {
		if errors.IsNotFound(err) {
			return nil
