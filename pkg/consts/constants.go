...
const (
	...
	SriovDevicePluginEnabledLabel         = "sriovnetwork.openshift.io/device-plugin"
	SriovDevicePluginEnabledLabelEnabled  = "Enabled"
	SriovDevicePluginEnabledLabelDisabled = "Disabled"
