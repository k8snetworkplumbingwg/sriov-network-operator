...
func (m *MockHostHelpersInterface) ReadServiceInjectionManifestFile(path, ovsConfig string) (*types.Service, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHostHelpersInterfaceMockRecorder) ReadServiceInjectionManifestFile(path, ovsConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
