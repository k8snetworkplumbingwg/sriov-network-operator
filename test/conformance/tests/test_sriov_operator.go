	...
	Describe("Custom SriovNetworkNodePolicy", func() {
		...
		Context("Resource Injector", func() {
			...
			It("SR-IOV Operator Config, disable Resource Injector", func() {
				...
				assertObjectIsNotFound("network-resources-injector-allow-traffic-api-server", &corev1.Service{})
				assertObjectIsNotFound("nri-control-switches", &networkv1.NetworkPolicy{})
			})
