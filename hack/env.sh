if [ -z $SKIP_VAR_SET ]; then
        ...
        export SRIOV_INFINIBAND_CNI_ENABLE=${SRIOV_INFINIBAND_CNI_ENABLE:-true}
        ...
        [ -z $SRIOV_INFINIBAND_CNI_ENABLE ] && echo "SRIOV_INFINIBAND_CNI_ENABLE is empty but SKIP_VAR_SET is set" && exit 1
